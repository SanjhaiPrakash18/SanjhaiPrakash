document.addEventListener('DOMContentLoaded', () => {
    const words = ["Experience", "Growth", "Progress", "Development", "Saga"];
    let index = 0;
    const dynamicWordElement = document.getElementById('dynamicExperienceWord');

    if (!dynamicWordElement) {
        console.error('Element with id "dynamicExperienceWord" not found.');
        return;
    }
