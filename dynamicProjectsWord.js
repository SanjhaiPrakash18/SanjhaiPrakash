document.addEventListener('DOMContentLoaded', () => {
    const words = ["Projects", "Endeavors", "Initiatives", "Ventures", "Creations"];
    let index = 0;
    const dynamicWordElement = document.getElementById('dynamicProjectsWord');

    if (!dynamicWordElement) {
        console.error('Element with id "dynamicProjectsWord" not found.');
        return;
    }
